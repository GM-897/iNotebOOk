...
const Login = (props) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        const response = await fetch("https://my-note-book-sigma.vercel.app/api/auth/login", {
            method: 'POST',
            headers: {
  ...
  return (
    <div className="mainlogin">
      <form className="mainformlogin" onSubmit={handleSubmit}>
        <div className="fs-4 mb-4">Welcome to <span className="fs-1 ">myNotebOOk</span></div>
        <div>
